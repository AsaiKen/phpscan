...
public class FrameworkTestCaseCompilerTest {
	...
	public void test() throws Exception {
		FrameworkTestCaseCompiler compiler = new FrameworkTestCaseCompiler(
				new File("test_resource/frameworkcompiler/case1"), "case1");
		compiler.compile();
	}
	...
	public void test2() throws Exception {
		FrameworkTestCaseCompiler compiler = new FrameworkTestCaseCompiler(
				new File("test_resource/frameworkcompiler/case2"), "case2");
		compiler.compile();
	}
	...
	public void test3() throws Exception {
		FrameworkTestCaseCompiler compiler = new FrameworkTestCaseCompiler(
				new File("test_resource/frameworkcompiler/case3"), "case3");
		compiler.compile();
	}
	...
	public void test4() throws Exception {
		FrameworkTestCaseCompiler compiler = new FrameworkTestCaseCompiler(
				new File("test_resource/frameworkcompiler/case4"), "case4");
		compiler.compile();
	}
	...
	public void test5() throws Exception {
		FrameworkTestCaseCompiler compiler = new FrameworkTestCaseCompiler(
				new File("test_resource/frameworkcompiler/case5"), "case5");
		compiler.compile();
	}
